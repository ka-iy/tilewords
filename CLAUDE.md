<!-- aidlc-start: AWS AI-DLC v1.0.1 core workflow — prepended by framework install; do not remove -->
<!-- Source: awslabs/aidlc-workflows core-workflow.md (v1.0.1). Rule details: .aidlc/aidlc-rules/aws-aidlc-rule-details/ -->
